-- Test3 inserts and deletes 5 000 rows into the given table
CREATE OR ALTER PROCEDURE my_runTest3 @tableID INT, @testID INT, @testRunID INT
AS
	...
	PRINT '5 000 rows will be inserted in table ' + @tableName + '.'
