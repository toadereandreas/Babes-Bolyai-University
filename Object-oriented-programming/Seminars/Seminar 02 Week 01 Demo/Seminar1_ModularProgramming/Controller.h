...
/// <summary>
/// Searches for the planets of a given type.
/// </summary>
/// <param name="c">Pointer to theController.</param>
/// <param name = "type">A string, the searched type; "null" - for all the planets.</param>
/// <returns>A repository of planets, that have the given type.</returns>
